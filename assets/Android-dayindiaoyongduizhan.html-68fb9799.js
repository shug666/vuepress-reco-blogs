import{_ as e,r as i,o as c,c as d,b as n,d as a,e as l,a as t}from"./app-390d99ab.js";const o={},p=t(`<h2 id="内核-驱动层" tabindex="-1"><a class="header-anchor" href="#内核-驱动层" aria-hidden="true">#</a> 内核&amp;驱动层</h2><ul><li><p>添加头文件：</p><div class="language-c line-numbers-mode" data-ext="c"><pre class="language-c"><code><span class="token macro property"><span class="token directive-hash">#</span><span class="token directive keyword">include</span> <span class="token string">&lt;linux/kprobes.h&gt;</span>  </span>
