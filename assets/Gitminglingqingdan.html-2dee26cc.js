...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p><code>https://blog.csdn.net/leslie3350/article/details/144792889</code></p></blockquote><h3 id="清理工作树和索引" tabindex="-1"><a class="header-anchor" href="#清理工作树和索引" aria-hidden="true">#</a> 清理工作树和索引</h3><p>加快git的速度，但会失去所有索引，需要手动添加对应文件/路径，否则合并会冲突</p><p><code>git rm -r --cached .</code> # 如果需要重新扫描所有文件状态的话</p><h2 id="git统计" tabindex="-1"><a class="header-anchor" href="#git统计" aria-hidden="true">#</a> git统计</h2><h3 id="_1-统计个人代码量" tabindex="-1"><a class="header-anchor" href="#_1-统计个人代码量" aria-hidden="true">#</a> 1. 统计个人代码量：</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> log <span class="token parameter variable">--author</span><span class="token operator">=</span><span class="token string">&quot;shugan1012&quot;</span> <span class="token parameter variable">--pretty</span><span class="token operator">=</span>tformat: <span class="token parameter variable">--numstat</span> <span class="token operator">|</span> <span class="token function">awk</span> <span class="token string">&#39;{ add += $1; subs += $2; loc += $1 - $2 } END { printf &quot;added lines: %s, removed lines: %s, total lines: %s\\n&quot;, add, subs, loc }&#39;</span> -
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_2、贡献值统计" tabindex="-1"><a class="header-anchor" href="#_2、贡献值统计" aria-hidden="true">#</a> 2、贡献值统计：</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> log <span class="token parameter variable">--pretty</span><span class="token operator">=</span><span class="token string">&#39;%aN&#39;</span> <span class="token operator">|</span> <span class="token function">sort</span> <span class="token parameter variable">-u</span> <span class="token operator">|</span> <span class="token function">wc</span> <span class="token parameter variable">-l</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="_3、查看排名前-5-的贡献者" tabindex="-1"><a class="header-anchor" href="#_3、查看排名前-5-的贡献者" aria-hidden="true">#</a> 3、查看排名前 5 的贡献者：</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">git</span> log <span class="token parameter variable">--pretty</span><span class="token operator">=</span><span class="token string">&#39;%aN&#39;</span> <span class="token operator">|</span> <span class="token function">sort</span> <span class="token operator">|</span> <span class="token function">uniq</span> <span class="token parameter variable">-c</span> <span class="token operator">|</span> <span class="token function">sort</span> <span class="token parameter variable">-k1</span> <span class="token parameter variable">-n</span> <span class="token parameter variable">-r</span> <span class="token operator">|</span> <span class="token function">head</span> <span class="token parameter variable">-n</span> <span class="token number">5</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><blockquote><p>https://cloud.tencent.com/developer/news/412401</p></blockquote>`,97);function b(h,g){const e=t("ExternalLinkIcon");return c(),l("div",null,[d,n("ol",null,[n("li",null,[a("把你 "),n("a",r,[a("commit"),p(e)]),a(" 到本地仓库的内容，取出来放到暂存区(stash)（这时你的工作区是干净的）")]),u,m]),v])}const f=i(o,[["render",b],["__file","Gitminglingqingdan.html.vue"]]);export{f as default};
