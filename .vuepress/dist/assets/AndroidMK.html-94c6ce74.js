import{_ as s,r as a,o as r,c,b as e,d as n,e as d,a as l}from"./app-e8f85126.js";const t={},v=l(`<h2 id="一、android-mk文件的作用" tabindex="-1"><a class="header-anchor" href="#一、android-mk文件的作用" aria-hidden="true">#</a> 一、Android.mk文件的作用</h2><p>Android.mk是Android工程管理文件，类似于编译文件的说明书，用来向编译系统描述源代码，并将源文件分组为模块（包括静态库、共享库、独立可执行文件）。Android.mk会被编译系统解析一次或多次，可以在每一个Android.mk文件中定义一个或多个模块，也可以多个模块使用同一个 .mk 文件。</p><h2 id="二、最基础的android-mk构成" tabindex="-1"><a class="header-anchor" href="#二、最基础的android-mk构成" aria-hidden="true">#</a> 二、最基础的Android.mk构成</h2><p><strong>Android.mk文件必须先定义LOCAL_PATH变量</strong></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>##源文件在开发树中的位置, 表示当前模块位置的变量
